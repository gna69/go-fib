...
type FibonacciClient interface {
	GetFibSlice(ctx context.Context, in *Segment, opts ...grpc.CallOption) (*FibonacciSlice, error)
}
...
func (c *fibonacciClient) GetFibSlice(ctx context.Context, in *Segment, opts ...grpc.CallOption) (*FibonacciSlice, error) {
	out := new(FibonacciSlice)
	err := c.cc.Invoke(ctx, "/grpc_api.Fibonacci/GetFibSlice", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type FibonacciServer interface {
	GetFibSlice(context.Context, *Segment) (*FibonacciSlice, error)
...
func (UnimplementedFibonacciServer) GetFibSlice(context.Context, *Segment) (*FibonacciSlice, error) {
...
func _Fibonacci_GetFibSlice_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/grpc_api.Fibonacci/GetFibSlice",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FibonacciServer).GetFibSlice(ctx, req.(*Segment))
	}
...
var Fibonacci_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "grpc_api.Fibonacci",
